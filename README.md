...
```text
Mobile developer passionate about crafting polished, performant cross-platform experiences.
I ship production apps across the full mobile stack — from native UI to shared business logic.

  🚀  8+ years of hands-on mobile development (since 2018)
...
[![My Skills](https://skillicons.dev/icons?i=react,flutter,swift,kotlin,ts,js,android,firebase,git,github,vscode,figma&perline=6)](https://skillicons.dev)

</div>

| Platform | Stack |
|----------|-------|
| **React Native** | TypeScript, Redux / Zustand, Native Modules |
| **Android** | Kotlin, Jetpack Compose, XML, CameraX, Material 3 |
| **iOS** | Swift, SwiftUI, UIKit |
| **Flutter** | Dart, BLoC / Riverpod, responsive UI |
...
|---------|-------------|-------|
| [**PhotonCamera**](https://github.com/nambo1351999/PhotonCamera) | Open-source Android camera app for static photography | Android · Kotlin |
| [**CameraMega**](https://github.com/nambo1351999/CameraMega) | Advanced camera application | Android · Mobile |
| [**polystack-studio**](https://github.com/nambo1351999/polystack-studio) | Creative mobile studio tool | Cross-platform |
| [**reverse-skill**](https://github.com/nambo1351999/reverse-skill) | AI skill router for security research & reverse engineering | AI · Cursor · Claude |

<details>
<summary>🔒 More projects (private)</summary>

<br>

`theme-zone` · `MyLauncher` · `GralleryAI` · `SuperCamera` · `image-to-desgin` · `agent-manager` · `mobile-ai-agents`
